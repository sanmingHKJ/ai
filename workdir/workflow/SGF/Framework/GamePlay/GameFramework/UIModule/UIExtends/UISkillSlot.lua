...
local UISkillSlot = UIClass.New("UISkillSlot", SuperSlotBase)

function UISkillSlot:Constructor()
    
end

function UISkillSlot:Destructor()
    
end

function UISkillSlot:Init(bindObj)
